...
- **Life Organization:** Meal planning, recipe management, pantry tracking, shopping lists, and home organization
- **Travel Planning:** Trip planning, itinerary management, and travel budgeting
- **AI-Powered Insights:** Automated recommendations, anomaly detection, forecasting, and personalized suggestions
- **Data Synchronization:** Cloud-based storage and multi-device synchronization
- **Customizable Dashboard:** Personalized widgets and layouts
...
- We are not liable for modifications or discontinuation of features
...
- Financial decisions based on inaccurate data are your responsibility
- You should regularly review and verify your data
...
### 5.2 Your Content
- You retain ownership of data and content you submit
- You grant us a license to use your data to provide the Service
- This license includes the right to process, store, and analyze your data
- This license terminates when you delete your content or account
- We do not claim ownership of your personal or financial data
...
- AI recommendations are not financial, legal, or professional advice
- You are solely responsible for financial decisions
- AI accuracy is not guaranteed
- You should verify AI-generated information

### 6.2 AI Data Usage
- We use your data to train and improve AI features
- Data is anonymized and aggregated when possible
- You can opt out of AI features in Settings
- Opting out may limit functionality

### 6.3 Third-Party AI Services
- We use Google Gemini Pro for AI capabilities
- Third-party AI services have their own terms and policies
...
### 7.2 Accuracy of Financial Data
- We do not guarantee the accuracy of calculations or projections
- You are responsible for verifying all financial information
- We are not liable for financial losses due to inaccurate data
- You should independently verify important financial decisions

### 7.3 Third-Party Financial Institutions
- We do not have relationships with your banks or financial institutions
- We do not access your bank accounts directly
- You are responsible for manually entering financial data
- We are not responsible for bank errors or discrepancies
...
- You consent to data collection and use as described in the Privacy Policy
...
### 11.1 Free Tier
- We currently offer the Service free of charge
- We reserve the right to introduce paid features or subscriptions
- Existing users will receive advance notice of pricing changes

### 11.2 Future Paid Features
If we introduce paid features:
- Pricing will be clearly disclosed before purchase
- Payments will be processed through secure third-party providers
- Subscriptions may auto-renew unless cancelled
- Refund policies will be clearly stated

### 11.3 Taxes
- You are responsible for all applicable taxes
- Prices do not include taxes unless stated otherwise

## 12. Cancellation and Termination

### 12.1 Your Right to Cancel
- You may cancel your account at any time
- Cancellation can be done through Settings > Privacy > Delete Account
- Account deletion is permanent and cannot be undone
- Some data may be retained for legal compliance (see Privacy Policy)
...
- For prolonged inactivity (with prior notice)
...
- You should export your data before cancelling your account
- Data export is available in Settings > Privacy > Download My Data
- We are not responsible for data loss after account deletion
...
- You may not use the Service if you are subject to trade sanctions or embargoes
- You may not use the Service in violation of export control laws
- You represent that you are not on any government restricted party list
...
- A waiver in one instance does not waive future instances
