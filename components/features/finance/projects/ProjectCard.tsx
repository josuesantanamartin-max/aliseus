                ...
                <div className="flex justify-between items-start mb-5">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                                <span className={`text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-widest ${project.status === 'ACTIVE' ? 'bg-cyan-50 text-cyan-600' : 'bg-onyx-50 text-onyx-600'}`}>
                                ...
                                {project.importance && project.importance !== 'MEDIA' && (
                                    <span className={`text-[9px] font-black px-2 py-0.5 rounded uppercase tracking-widest ${project.importance === 'ALTA' ? 'bg-red-50 text-red-500' : 'bg-onyx-50 text-onyx-400'}`}>
                            ...
                            <div className="flex items-center gap-3 mt-2 flex-wrap text-[10px] text-onyx-400">
                                {project.keyDate && (
                    ...
                    <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        {subProjects.length === 0 && (
                            <button onClick={() => onOpenNewItem(project)} className="p-2 hover:bg-cyan-50 rounded-xl text-onyx-400 hover:text-cyan-600 transition-colors" title="Añadir partida">
                                <Plus className="w-4 h-4" />
                            </button>
                        )}
                        <button onClick={() => onOpenNewProject(project.id)} className="p-2 hover:bg-violet-50 rounded-xl text-onyx-400 hover:text-violet-600 transition-colors" title="Añadir sub-proyecto"><FolderPlus className="w-4 h-4" /></button>
                        <button onClick={() => onEditProject(project)} className="p-2 hover:bg-onyx-50 rounded-xl text-onyx-400 hover:text-cyan-600 transition-colors"><Pencil className="w-4 h-4" /></button>
