                                    ...
                                    <tr key={item.id} className="group hover:bg-onyx-50/50 transition-colors">
                                        ...
                                        <td className="py-2.5">
                                            <div className="flex gap-1 justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button onClick={() => onOpenEditItem(item, project)} className="p-1 hover:bg-cyan-50 rounded text-onyx-400 hover:text-cyan-600 transition-colors"><Pencil className="w-3 h-3" /></button>
                                                <button onClick={() => { if (window.confirm('¿Eliminar esta partida?')) onDeleteItem(item.id); }} className="p-1 hover:bg-red-50 rounded text-onyx-400 hover:text-red-500 transition-colors"><Trash2 className="w-3 h-3" /></button>
                                            </div>
                                        </td>
                                    </tr>
                                );
