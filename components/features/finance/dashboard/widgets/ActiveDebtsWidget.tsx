    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6 px-2">
                ...
                <button onClick={() => onNavigate('finance', 'debts')} className="text-xs font-bold text-aliseus-400 hover:text-cyan-900 flex items-center gap-2 transition-colors group">
            ...
            {activeDebts.length > 0 ? (
                                ...
                                <div className="flex-1 space-y-2.5 min-w-0">
                                    <div className="flex justify-between items-end gap-4">
                                        <div className="flex items-end gap-5">
                                            ...
                                            <div className="h-8 w-px bg-aliseus-100 dark:bg-aliseus-800 mb-0.5"></div>
                                            <div className="whitespace-nowrap">
                                                <p className="text-[9px] font-black text-aliseus-400 dark:text-aliseus-500 uppercase tracking-widest mb-0.5">Original</p>
                                                <p className="text-base font-bold text-aliseus-400 dark:text-aliseus-500 tracking-tight leading-none">{formatEUR(debt.originalAmount)}</p>
                                            </div>
                                        </div>
                                        <div className="text-right shrink-0">
                                            <span className="text-[11px] font-black text-aliseus-600 dark:text-aliseus-300 bg-aliseus-50 dark:bg-aliseus-800 px-2.5 py-0.5 rounded-full border border-aliseus-100 dark:border-aliseus-700">{progress.toLocaleString('es-ES', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}%</span>
                                        </div>
                                    </div>

                                    <div className="w-full bg-aliseus-50 dark:bg-aliseus-800 h-2.5 rounded-full overflow-hidden border border-aliseus-100/50 dark:border-aliseus-700/50 relative">
                                    ...
                                    <div className="flex justify-between items-center text-[9px] font-black text-aliseus-400 uppercase tracking-widest">
                ...
                <div className="bg-white p-12 rounded-Aliseus border border-aliseus-100 text-center shadow-sm">
                    ...
                    <h4 className="text-xl font-bold text-aliseus-900 mb-2">¡Sin deudas activas!</h4>
                    <p className="text-xs text-aliseus-400 font-bold uppercase tracking-[0.2em]">Tu salud financiera es excelente</p>
                </div>
            )}
        </div>
    );
