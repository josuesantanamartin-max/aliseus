...
import { Map, Plus, Luggage, Globe, Sparkles, MapPin, Calendar, Wallet, ArrowRight, CalendarDays } from 'lucide-react';
...
export const TravelHub: React.FC<TravelHubProps> = ({ trips, currency, onOpenMap, onNewTrip, onSelectTrip }) => {
    ...
    return (
        <div className="space-y-8 p-8 animate-fade-in pb-20 overflow-y-auto h-full">
            ...
            <div>
                {totalTrips > 0 && <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 mb-6 px-2">Tus Expediciones</h3>}
                ...
                {totalTrips > 0 ? (
                    ...
                    <TravelEmptyState onNewTrip={onNewTrip} />
                )}
            </div>
        </div>
    );
