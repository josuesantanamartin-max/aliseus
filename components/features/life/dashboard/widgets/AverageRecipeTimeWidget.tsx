        ...
        <div className="bg-white dark:bg-onyx-900 p-6 rounded-[2rem] h-full flex flex-col border border-onyx-100 dark:border-onyx-800 shadow-sm hover:shadow-md transition-all">
            <div className="flex justify-between items-start mb-5">
                <div>
                    ...
                    <h3 className="text-lg font-black text-onyx-950 dark:text-white">Tiempo de Recetas</h3>
                </div>
            ...
            <div className="flex-1 flex flex-col justify-center">
                <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-6xl font-black tracking-tighter text-onyx-950 dark:text-white">
                        {stats.avg}
                    </span>
                    <span className="text-xl font-black text-onyx-400 uppercase tracking-tighter">min</span>
                </div>
                <p className="text-[10px] font-black text-onyx-400 uppercase tracking-widest">Media por Plato</p>
                ...
                <div className="mt-8 p-4 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 border border-amber-100 dark:border-amber-900/20">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-white dark:bg-onyx-900 rounded-xl shadow-sm">
                            <Zap className="w-4 h-4 text-amber-500" />
                        </div>
                        <div>
                            <p className="text-sm font-black text-onyx-900 dark:text-white leading-tight">
                                {stats.fast} recetas rápidas
                            </p>
                            <p className="text-[10px] font-bold text-onyx-500">Listas en menos de 20 min</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <button 
                ...
                className="mt-6 flex items-center justify-center gap-2 py-3 border-2 border-dashed border-onyx-100 dark:border-onyx-800 rounded-2xl text-[10px] font-black text-onyx-400 hover:text-amber-500 hover:border-amber-200 transition-all uppercase tracking-widest"
            >
