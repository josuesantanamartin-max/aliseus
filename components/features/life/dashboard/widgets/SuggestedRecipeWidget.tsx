        ...
        <div className="bg-white dark:bg-aliseus-900 p-6 rounded-[2rem] h-full flex flex-col border border-aliseus-100 dark:border-aliseus-800 shadow-sm hover:shadow-md transition-all">
            <div className="flex justify-between items-start mb-5">
                <div>
                    ...
                    <h3 className="text-lg font-black text-aliseus-950 dark:text-white">Receta Sugerida</h3>
                </div>
            ...
            <div className="space-y-4 flex-1 overflow-y-auto">
                {suggestions.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center text-center py-4">
                        <Sparkles className="w-8 h-8 text-aliseus-200 dark:text-aliseus-700 mb-2" />
                        <p className="text-xs font-bold text-aliseus-400 dark:text-aliseus-500">¿Qué tal una receta nueva?</p>
                        <button 
                    ...
                    suggestions.map(recipe => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-2">
                                <h4 className="text-sm font-black text-aliseus-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                                    {recipe.name}
                                </h4>
                                {recipe.score === 1 && (
                            ...
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-1 text-aliseus-500 dark:text-aliseus-400">
            ...
            <p className="mt-4 text-[9px] font-bold text-aliseus-400 dark:text-aliseus-500 italic">
