                    ...
                    <div className="relative z-10 flex items-center gap-5">
                        <div className="relative">
                            <div className="w-16 h-16 rounded-[20px] bg-gradient-to-tr from-blue-500 via-indigo-500 to-violet-500 p-[1.5px] shadow-lg ring-2 ring-white dark:ring-black/50">
                                <div className="w-full h-full bg-slate-50 dark:bg-onyx-950 rounded-[19px] flex items-center justify-center overflow-hidden">
                            ...
                            <div className="absolute -bottom-1.5 -right-1.5 w-6 h-6 bg-emerald-500 border-[3px] border-white dark:border-onyx-950 rounded-[8px] flex items-center justify-center shadow-lg">
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center gap-4 px-5 py-4 rounded-[22px] transition-all duration-300 relative group overflow-hidden ${isActive
                                ...
                                : 'hover:bg-white/80 dark:hover:bg-onyx-900/50 border border-transparent hover:border-slate-100 dark:hover:border-onyx-800'
                                }`}
                        >
                            <div className={`relative z-10 flex items-center justify-center w-9 h-9 rounded-xl transition-all duration-500 ${isActive
                                ...
                                : 'bg-slate-100 dark:bg-onyx-800 text-slate-400 dark:text-onyx-400 group-hover:scale-110 group-hover:shadow-md'
                                }`}>
                            ...
                            <span className={`relative z-10 flex-1 text-left text-[13px] font-black tracking-tight transition-all duration-300 uppercase ${isActive
                                ...
                                : 'text-slate-500 dark:text-onyx-400 group-hover:text-slate-900 dark:group-hover:text-white'
                                }`}>
                                {label}
                            </span>
                            ...
                            {!isActive && (
                                <ChevronRight className="w-3.5 h-3.5 text-gray-300 dark:text-onyx-700 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300" />
                            )}
                        </button>
                    );
                })}
